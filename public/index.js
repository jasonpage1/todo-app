...
const todoTime = document.querySelector(".todo-date");
const todoHour = document.querySelector(".todo-time");
//Event Listeners
...
function addTodo(e) {
 ...
 newTodo.appendChild(task)
  ...
  todoDate.innerHTML = todoTime.value;
newTodo.appendChild(todoDate)

  //add time 
  const todoTimeClock = document.createElement("div")
  todoTimeClock.innerHTML = todoHour.value;
  newTodo.appendChild(todoTimeClock)
